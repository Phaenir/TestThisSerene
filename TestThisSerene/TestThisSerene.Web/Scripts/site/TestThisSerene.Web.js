...
(function (TestThisSerene) {
    ...
    (function (Northwind) {
        var TerritoryDialog = (function (_super) {
            ...
            TerritoryDialog.prototype.getLanguages = function () {
                return TestThisSerene.LanguageList.getValue();
            };
    ...
    })(Northwind = TestThisSerene.Northwind || (TestThisSerene.Northwind = {}));
    ...
    (function (Northwind) {
        var ProductGrid = (function (_super) {
            ...
            ProductGrid.prototype.getButtons = function () {
                ...
                buttons.push(TestThisSerene.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    service: Northwind.ProductService.baseUrl + '/ListExcel',
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    separator: true
                }));
                buttons.push(TestThisSerene.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
    ...
    (function (Common) {
        var BulkServiceAction = (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new TestThisSerene.BasicProgressDialog();
...
(function (TestThisSerene) {
    ...
    (function (BasicSamples) {
        ...
        }(TestThisSerene.Common.BulkServiceAction));
    ...
    (function (Northwind) {
        var OrderDialog = (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                ...
                buttons.push(TestThisSerene.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: TestThisSerene.Authorization.userDefinition.DisplayName,
    ...
    (function (Northwind) {
        var CustomerDialog = (function (_super) {
            ...
            function CustomerDialog() {
                ...
                TestThisSerene.DialogUtils.pendingChangesConfirmation(this.element, function () { return _this.getSaveState() != _this.loadedState; });
...
(function (TestThisSerene) {
    ...
    (function (MovieDB) {
        var PersonEditor = (function (_super) {
            ...
            PersonEditor.prototype.getColumnsKey = function () { return 'MovieDB.Person'; };
            PersonEditor.prototype.getDialogType = function () { return MovieDB.PersonEditorDialog; };
            PersonEditor.prototype.getLocalTextPrefix = function () { return MovieDB.PersonRow.localTextPrefix; };
            PersonEditor = __decorate([
                Serenity.Decorators.registerClass()
            ], PersonEditor);
            return PersonEditor;
        }(TestThisSerene.Common.GridEditorBase));
        MovieDB.PersonEditor = PersonEditor;
    })(MovieDB = TestThisSerene.MovieDB || (TestThisSerene.MovieDB = {}));
})(TestThisSerene || (TestThisSerene = {}));
/// <reference path="../../Common/Helpers/GridEditorDialog.ts" />
var TestThisSerene;
(function (TestThisSerene) {
    ...
    (function (MovieDB) {
        var PersonEditorDialog = (function (_super) {
            ...
            PersonEditorDialog.prototype.getFormKey = function () { return MovieDB.PersonForm.formKey; };
            PersonEditorDialog.prototype.getLocalTextPrefix = function () { return MovieDB.PersonRow.localTextPrefix; };
            PersonEditorDialog.prototype.getNameProperty = function () { return MovieDB.PersonRow.nameProperty; };
        ...
        MovieDB.PersonEditorDialog = PersonEditorDialog;
    })(MovieDB = TestThisSerene.MovieDB || (TestThisSerene.MovieDB = {}));
})(TestThisSerene || (TestThisSerene = {}));
var TestThisSerene;
(function (TestThisSerene) {
...
(function (TestThisSerene) {
    ...
    (function (MovieDB) {
        var GenreEditor = (function (_super) {
            ...
            GenreEditor.prototype.getColumnsKey = function () { return 'MovieDB.Genre'; };
            GenreEditor.prototype.getDialogType = function () { return MovieDB.GenreEditorDialog; };
            GenreEditor.prototype.getLocalTextPrefix = function () { return MovieDB.GenreRow.localTextPrefix; };
            GenreEditor = __decorate([
                Serenity.Decorators.registerClass()
            ], GenreEditor);
            return GenreEditor;
        }(TestThisSerene.Common.GridEditorBase));
        MovieDB.GenreEditor = GenreEditor;
    })(MovieDB = TestThisSerene.MovieDB || (TestThisSerene.MovieDB = {}));
})(TestThisSerene || (TestThisSerene = {}));
/// <reference path="../../Common/Helpers/GridEditorDialog.ts" />
var TestThisSerene;
(function (TestThisSerene) {
    ...
    (function (MovieDB) {
        var GenreEditorDialog = (function (_super) {
            ...
            GenreEditorDialog.prototype.getFormKey = function () { return MovieDB.GenreForm.formKey; };
            GenreEditorDialog.prototype.getLocalTextPrefix = function () { return MovieDB.GenreRow.localTextPrefix; };
            GenreEditorDialog.prototype.getNameProperty = function () { return MovieDB.GenreRow.nameProperty; };
        ...
        MovieDB.GenreEditorDialog = GenreEditorDialog;
    })(MovieDB = TestThisSerene.MovieDB || (TestThisSerene.MovieDB = {}));
})(TestThisSerene || (TestThisSerene = {}));
var TestThisSerene;
(function (TestThisSerene) {
...
(function (TestThisSerene) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return TestThisSerene.Northwind.CustomerEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['CategoryID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return BasicSamples.FilteredLookupDetailEditor; }]].forEach(function (x) { return Object.defineProperty(FilteredLookupInDetailForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = TestThisSerene.BasicSamples || (TestThisSerene.BasicSamples = {}));
})(TestThisSerene || (TestThisSerene = {}));
var TestThisSerene;
(function (TestThisSerene) {
...
(function (TestThisSerene) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return TestThisSerene.Northwind.CustomerEditor; }], ['CustomerContactName', function () { return Serenity.StringEditor; }], ['CustomerContactTitle', function () { return Serenity.StringEditor; }], ['CustomerCity', function () { return Serenity.StringEditor; }], ['CustomerRegion', function () { return Serenity.StringEditor; }], ['CustomerCountry', function () { return Serenity.StringEditor; }], ['CustomerPhone', function () { return Serenity.StringEditor; }], ['CustomerFax', function () { return Serenity.StringEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['RequiredDate', function () { return Serenity.DateEditor; }], ['EmployeeID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return TestThisSerene.Northwind.OrderDetailsEditor; }]].forEach(function (x) { return Object.defineProperty(PopulateLinkedDataForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = TestThisSerene.BasicSamples || (TestThisSerene.BasicSamples = {}));
})(TestThisSerene || (TestThisSerene = {}));
var TestThisSerene;
(function (TestThisSerene) {
...
(function (TestThisSerene) {
    ...
    (function (BasicSamples) {
        ...
        [['StaticText', function () { return TestThisSerene.StaticTextBlock; }], ['SomeInput', function () { return Serenity.StringEditor; }], ['HtmlList', function () { return TestThisSerene.StaticTextBlock; }], ['FromLocalText', function () { return TestThisSerene.StaticTextBlock; }], ['DisplayFieldValue', function () { return TestThisSerene.StaticTextBlock; }]].forEach(function (x) { return Object.defineProperty(StaticTextBlockForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = TestThisSerene.BasicSamples || (TestThisSerene.BasicSamples = {}));
})(TestThisSerene || (TestThisSerene = {}));
var TestThisSerene;
(function (TestThisSerene) {
...
(function (TestThisSerene) {
    ...
    })(Modules = TestThisSerene.Modules || (TestThisSerene.Modules = {}));
})(TestThisSerene || (TestThisSerene = {}));
var TestThisSerene;
(function (TestThisSerene) {
    var MovieDB;
    (function (MovieDB) {
        ...
        [['Genre', function () { return Serenity.StringEditor; }]].forEach(function (x) { return Object.defineProperty(GenreForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(MovieDB = TestThisSerene.MovieDB || (TestThisSerene.MovieDB = {}));
})(TestThisSerene || (TestThisSerene = {}));
var TestThisSerene;
(function (TestThisSerene) {
    ...
    (function (MovieDB) {
        ...
        (function (GenreRow) {
            ...
            ['GenreId', 'Genre'].forEach(function (x) { return Fields[x] = x; });
...
(function (TestThisSerene) {
    ...
    (function (MovieDB) {
        ...
        (function (MovieGenresRow) {
            ...
            ['MovieGenreId', 'MovieId', 'GenreId', 'MovieTitle', 'MovieDescription', 'MovieStoryline', 'MovieYear', 'MovieReleaseDate', 'MovieRuntime', 'MovieKind', 'Genre'].forEach(function (x) { return Fields[x] = x; });
...
(function (TestThisSerene) {
    ...
    (function (MovieDB) {
        ...
        (function (PersonRow) {
            ...
            ['PersonId', 'FirstName', 'LastName', 'Birthdate', 'BirthPlace', 'Gender', 'Height', 'FullName'].forEach(function (x) { return Fields[x] = x; });
...
(function (TestThisSerene) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnum(Gender, 'TestThisSerene.Northwind.Entities.Gender');
    })(Northwind = TestThisSerene.Northwind || (TestThisSerene.Northwind = {}));
})(TestThisSerene || (TestThisSerene = {}));
var TestThisSerene;
(function (TestThisSerene) {
...
(function (TestThisSerene) {
    ...
    TestThisSerene.BasicProgressDialog = BasicProgressDialog;
})(TestThisSerene || (TestThisSerene = {}));
var TestThisSerene;
(function (TestThisSerene) {
    var DialogUtils;
    ...
    })(DialogUtils = TestThisSerene.DialogUtils || (TestThisSerene.DialogUtils = {}));
})(TestThisSerene || (TestThisSerene = {}));
var TestThisSerene;
(function (TestThisSerene) {
    var Common;
...
(function (TestThisSerene) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = TestThisSerene.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = TestThisSerene.LanguageList || (TestThisSerene.LanguageList = {}));
})(TestThisSerene || (TestThisSerene = {}));
var TestThisSerene;
(function (TestThisSerene) {
    var Common;
...
(function (TestThisSerene) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return TestThisSerene.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return TestThisSerene.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return TestThisSerene.Northwind.SalesByCategoryService.baseUrl; };
            /**
        ...
        var TreeGrid = (function (_super) {
            ...
            function TreeGrid(container) {
                ...
                this.treeMixin = new Serenity.TreeGridMixin({
                    ...
                    toggleField: TestThisSerene.Northwind.OrderRow.Fields.CustomerCompanyName,
            ...
            return TreeGrid;
        }(TestThisSerene.Northwind.OrderGrid));
...
(function (TestThisSerene) {
    ...
    (function (BasicSamples) {
        ...
        }(TestThisSerene.Northwind.SupplierGrid));
...
(function (TestThisSerene) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return TestThisSerene.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return TestThisSerene.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return TestThisSerene.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return TestThisSerene.Northwind.OrderService.baseUrl; };
            /**
            ...
            QuickFilterCustomization.prototype.getQuickFilters = function () {
                ...
                var fld = TestThisSerene.Northwind.OrderRow.Fields;
...
(function (TestThisSerene) {
    ...
    (function (BasicSamples) {
        ...
        }(TestThisSerene.Northwind.ProductGrid));
...
(function (TestThisSerene) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return TestThisSerene.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return TestThisSerene.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return TestThisSerene.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return TestThisSerene.Northwind.ProductService.baseUrl; };
...
(function (TestThisSerene) {
    ...
    (function (BasicSamples) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            TestThisSerene.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
                        ...
                        var dlg = new TestThisSerene.Northwind.OrderDialog();
                        this.initDialog(dlg);
        ...
        }(TestThisSerene.Northwind.CustomerGrid));
        ...
        var InitialValuesForQuickFilters = (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == fld.ShippingState; }).init = function (w) {
                    ...
                    w.value = TestThisSerene.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
...
(function (TestThisSerene) {
    ...
    TestThisSerene.SelectableEntityGrid = SelectableEntityGrid;
})(TestThisSerene || (TestThisSerene = {}));
...
(function (TestThisSerene) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return TestThisSerene.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return TestThisSerene.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return TestThisSerene.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return TestThisSerene.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(TestThisSerene.SelectableEntityGrid));
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(TestThisSerene.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new TestThisSerene.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new TestThisSerene.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new TestThisSerene.Northwind.OrderDialog().loadEntityAndOpenDialog({
                        CustomerID: item.CustomerID,
                    ...
                    var countryFilter = this.findQuickFilter(Serenity.LookupEditor, TestThisSerene.Northwind.OrderRow.Fields.ShipCountry);
...
(function (TestThisSerene) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return TestThisSerene.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return TestThisSerene.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return TestThisSerene.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return TestThisSerene.Northwind.ProductService.baseUrl; };
            /**
            ...
            ConditionalFormattingGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = TestThisSerene.Northwind.ProductRow.Fields;
...
(function (TestThisSerene) {
    ...
    TestThisSerene.StaticTextBlock = StaticTextBlock;
})(TestThisSerene || (TestThisSerene = {}));
var TestThisSerene;
(function (TestThisSerene) {
    var BasicSamples;
...
(function (TestThisSerene) {
    ...
    (function (BasicSamples) {
        ...
        }(TestThisSerene.Northwind.ProductDialog));
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return TestThisSerene.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (TestThisSerene) {
    ...
    (function (BasicSamples) {
        ...
        }(TestThisSerene.Northwind.OrderDetailsEditor));
...
(function (TestThisSerene) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return TestThisSerene.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return TestThisSerene.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return TestThisSerene.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return TestThisSerene.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                _super.call(this);
                this.form = new TestThisSerene.Northwind.OrderDetailForm(this.idPrefix);
                ...
                this.form.ProductID.cascadeField = TestThisSerene.Northwind.ProductRow.Fields.CategoryID;
        ...
        }(TestThisSerene.Northwind.OrderDetailDialog));
        ...
        var ChangingLookupTextDialog = (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                this.form.ProductID.changeSelect2(function (e) {
                    var productID = Q.toId(_this.form.ProductID.value);
                    if (productID != null) {
                        _this.form.UnitPrice.value = TestThisSerene.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
                this.form.Discount.addValidationRule(this.uniqueName, function (e) {
                    var price = _this.form.UnitPrice.value;
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return TestThisSerene.Northwind.OrderDetailRow.localTextPrefix; };
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return TestThisSerene.Northwind.ProductRow.lookupKey;
            };
...
(function (TestThisSerene) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    TestThisSerene.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(TestThisSerene.Northwind.CustomerDialog));
...
(function (TestThisSerene) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return TestThisSerene.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return TestThisSerene.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return TestThisSerene.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return TestThisSerene.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return TestThisSerene.Northwind.OrderService.baseUrl; };
...
(function (TestThisSerene) {
    ...
    (function (BasicSamples) {
        ...
        }(TestThisSerene.Northwind.SupplierDialog));
        ...
        var PopulateLinkedDataDialog = (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(TestThisSerene.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    TestThisSerene.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return TestThisSerene.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return TestThisSerene.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return TestThisSerene.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return TestThisSerene.Northwind.OrderService.baseUrl; };
...
(function (TestThisSerene) {
    ...
    (function (BasicSamples) {
        ...
        var OtherFormInTabOneBarDialog = (function (_super) {
            ...
            function OtherFormInTabOneBarDialog() {
                ...
                this.customerPropertyGrid = new Serenity.PropertyGrid(this.byId("CustomerPropertyGrid"), {
                    items: Q.getForm(TestThisSerene.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                this.customerForm = new TestThisSerene.Northwind.CustomerForm(this.customerPropertyGrid.idPrefix);
            ...
            OtherFormInTabOneBarDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(TestThisSerene.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
            ...
            OtherFormInTabOneBarDialog.prototype.saveCustomer = function (callback, onSuccess) {
                ...
                if (!id) {
                    ...
                    TestThisSerene.Northwind.CustomerService.Update({
                        EntityId: id,
                        Entity: c
                    }, function (response) {
                        // reload customer list just in case
                        Q.reloadLookup(TestThisSerene.Northwind.CustomerRow.lookupKey);
        ...
        }(TestThisSerene.Northwind.OrderDialog));
...
(function (TestThisSerene) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew) {
                    ...
                    TestThisSerene.Northwind.CategoryService.Retrieve({
        ...
        }(TestThisSerene.Northwind.CategoryDialog));
...
(function (TestThisSerene) {
    ...
    (function (BasicSamples) {
        ...
        }(TestThisSerene.Northwind.CategoryGrid));
        ...
        var DefaultValuesInNewGrid = (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: TestThisSerene.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: TestThisSerene.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var chai = TestThisSerene.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = TestThisSerene.Northwind.EmployeeRow.getLookup().items
...
//# sourceMappingURL=TestThisSerene.Web.js.map